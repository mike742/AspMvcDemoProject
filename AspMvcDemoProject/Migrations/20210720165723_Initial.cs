    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    V_code = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    V_name = table.Column<string>(nullable: true),
                    V_contact = table.Column<string>(nullable: true),
                    V_AreaCode = table.Column<int>(nullable: false),
                    V_phone = table.Column<string>(nullable: true),
                    V_state = table.Column<string>(nullable: true),
                    V_order = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    P_descript = table.Column<string>(nullable: true),
                    P_InDate = table.Column<DateTime>(nullable: false),
                    P_QOH = table.Column<int>(nullable: false),
                    P_Min = table.Column<int>(nullable: false),
                    P_Price = table.Column<double>(nullable: false),
                    P_Discount = table.Column<double>(nullable: false),
                    V_code = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
